<template>
  <q-page class="q-pa-lg">
    <div class="text-h4 text-primary">Gestión de Usuarios</div>

    <div class="text-grey-7 q-mb-lg">Administra los usuarios registrados en la plataforma.</div>
    ...
    <q-spinner v-if="loading" color="primary" size="45px" />

    <div v-else class="row q-col-gutter-lg">
      <div v-for="usuario in usuariosFiltrados" :key="usuario.id" class="col-12 col-md-6 col-lg-4">
        <q-card class="user-card">
          <q-card-section>
            ...
            <div class="row justify-between">
              ...
              <q-badge :color="usuario.activo ? 'positive' : 'negative'">
    ...
    <q-dialog v-model="dialogPerfil">
      <q-card class="profile-card">
        ...
        <q-card-section>
          ...
          <div class="q-mb-sm"><strong>Rol:</strong> {{ usuarioSeleccionado?.rol }}</div>
          ...
          <div class="q-mb-sm">
            <strong>Registro:</strong> {{ formatearFecha(usuarioSeleccionado?.fechaRegistro) }}
          </div>
          ...
          <q-linear-progress
            ...
            class="q-mt-md"
          />
          <div class="text-caption text-grey-7 q-mt-xs">Actividad en la plataforma</div>
        </q-card-section>
...
const usuariosFiltrados = computed(() => {
  ...
  return usuarios.value
    ...
    .filter(
      (u) =>
        u.nombreCompleto.toLowerCase().includes(texto) || u.email.toLowerCase().includes(texto),
    )
})
